        ...
        <div class="row">
            <div class="col-xl-4 col-lg-4 col-md-4 col-sm-12">
                <div class="service-box">
                    <i><img src="frontend/icon/service1.png" /></i>
                    <h3>Fast service</h3>
            ...
            <div class="col-xl-4 col-lg-4 col-md-4 col-sm-12">
                <div class="service-box">
                    <i><img src="frontend/icon/service2.png" /></i>
            ...
            <div class="col-xl-4 col-lg-4 col-md-4 col-sm-12">
                <div class="service-box">
                    <i><img src="frontend/icon/service3.png" /></i>
                    <h3>Expert team</h3>
                    <p>Exerci tation ullamcorper suscipit lobortis nisl ut aliquip ex ea </p>
                </div>
            </div>
            <div class="col-xl-4 col-lg-4 col-md-4 col-sm-12">
                <div class="service-box">
                    <i><img src="frontend/icon/service4.png" /></i>
            ...
            <div class="col-xl-4 col-lg-4 col-md-4 col-sm-12">
                <div class="service-box">
                    <i><img src="frontend/icon/service5.png" /></i>
            ...
            <div class="col-xl-4 col-lg-4 col-md-4 col-sm-12">
                <div class="service-box">
                    <i><img src="frontend/icon/service6.png" /></i>
                    <h3>Award winning</h3>
                    <p>Exerci tation ullamcorper suscipit lobortis nisl ut aliquip ex ea </p>
                </div>
            </div>
                ...
                <div class="carousel-inner">
                    ...
                    <div class="carousel-item active">
                        <div class="container">
                            <div class="carousel-caption text-bg">
                                <div class="img_bg">
                                    <i><img src="frontend/images/lllll.png" /><span>Shuhratbek<br><strong class="date"></strong></span></i>
                    ...
                    <div class="carousel-item">
                        <div class="container">
                            <div class="carousel-caption text-bg">
                                <div class="img_bg">
                                    <i><img src="frontend/images/lllll.png" /><span>{{ $user->name }}<br><strong class="date">{{ $user->created_at->diffForHumans() }}</strong></span></i>
